    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="max-w-2xl w-full bg-card/60 border border-stroke rounded-xl p-8 shadow-lg">
        ...
        <p className="text-slate-400 mb-6 leading-relaxed">
          {examName}. {totalQuestions} preguntas aleatorias, {durationMinutes} minutos, aprobación en{' '}
          {passScore}/1000 puntos — igual que el examen real.
        </p>

        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          <Feature icon={<ListChecks size={20} />} label={`${totalQuestions} preguntas`} sub="elegidas al azar" />
          <Feature icon={<Clock size={20} />} label={`${durationMinutes} minutos`} sub="cronómetro regresivo" />
